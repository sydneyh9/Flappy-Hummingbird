...
def create_world() :
    ...
    sun = {
        "rect": pygame.Rect(WIDTH - 100, 50, 80, 80),
        "color": "yellow"
    }
    #creates a cloud object
    cloud = {
        "rect": pygame.Rect(WIDTH - 50, 120, 60, 40),
        "color": "white"
    }
    ...
    return {
        ...
        #pipe speed
        "pipe speed": PIPE_SPEED,
        #timer for how long game has gone on
        "time": 0,
        "sun": sun,
        #sun speed across screen
        "sun speed": SUN_SPEED,
        "cloud": cloud,
        #cloud speed across screen
        "cloud speed": CLOUD_SPEED,
        #state flag for game over
        "game_over": False,
        #state flag for win
        "win": False
    }
...
def count_time(world):
    '''
#his function increases the time variable
